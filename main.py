...
def load_data(file_path):
    ...
    cols = {
        ...
        'A150a': 'specialisms_mumc', # split categories, last 12 months
        'A16a': 'hospitalization', # yes/no last 12 months
        'A18a': 'n_ae_visits', # last 12 months
        'C1a': 'specialisms_visits', # CHECK THAT ONE C1
        ...
        'A150b': 'specialisms_not_mumc', # split categories
    ...
    split_cols = {
        ...
        'specialisms_mumc': np.arange(1, 20),
        'risky_substances': np.arange(1, 13),
        'specialisms_not_mumc': np.arange(1, 20),
...
if __name__ == '__main__':
    ...
    df.to_csv('data/med_recon_dummies.csv', encoding='utf-8', index=False)
